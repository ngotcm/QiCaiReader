...
var handler = require('crawlit/lib/plugins/parseHelper.js');
...
exports.parseLinks = function ($, push) {
  ...
  if (config.crawlOptions.recursive) {
    handler.parse($, $('a[href*="thread-50247-"]'), 'link', function (link) {
      logger.debug('Push link:', link.attr('href'));
...
exports.modify = function ($, handler) {
  ...
  posts.each(function (index, post) {
    ...
    $('a[href*="forum.php"]', postContent).removeAttr('href').removeAttr('target');
